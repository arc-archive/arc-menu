...
import { HistoryListMixin, ListStyles, internals } from '@advanced-rest-client/requests-list';

/**
 * Advanced REST Client's history menu element.
 */
export class HistoryMenuElement extends HistoryListMixin(LitElement) {
  static get styles() {
    return ListStyles;
  }
