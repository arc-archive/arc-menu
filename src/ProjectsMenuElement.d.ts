...
import { ARCSavedRequest, ARCProject } from '@advanced-rest-client/arc-models';
...
export declare interface ProjectsMenuElement extends ProjectsListConsumerMixin, SavedListMixin, LitElement {
}
...
export declare class ProjectsMenuElement {
   ...
   */
  [projectItemTemplate](project: ARCProject, index: number): TemplateResult;
