...
import { ListMixin } from '@advanced-rest-client/requests-list';
...
export declare class SearchMenuElement extends ListMixin(LitElement) {
   ...
   */
  [postQuery](results: (ARCHistoryRequest | ARCSavedRequest)[]): Promise<void>;

  /**
   * Post processes history object
   */
  [postProcessHistoryItem](item: ARCHistoryRequest): Promise<HistorySearchItem>;

  /**
   * Post processes saved object
   */
  [postProcessSavedItem](item: ARCSavedRequest): Promise<SavedSearchItem>;
